...
/*   Updated: 2023/05/04 20:51:05 by sde-mull         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int render(t_win *win)
{
	...
	objs()->temp_player = objs()->player;
	// if (eng()->keys.space == 1 && !act()->falling)
	// 	jump(0.06);
	if (!act()->jumping)
		gravity(&objs()->temp_player, 0.06);
	paint_all();
